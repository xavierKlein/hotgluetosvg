...
#then
#left=$(python -c "print $widthB-$width")
#fi
...
$(inkscape -f $file -A page${pageN}.pdf)
 ...
 #$(convert -density 300 ${newfile}.pdf ${newfile}.ps)
#$(ps2pdf ${newfile}.ps)
#$(ps2pdf  -dOptimize=true -dEmbedAllFonts=true ${newfile}.ps)
#$(ps2pdf ${newfile}.ps ${newfile}300.pdf)
